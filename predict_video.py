...
# python predict_video.py --model model/activity.model --label-bin model_own/lb.pickle --input example_clips/cyclone_movie.mp4 --output output/cyclon_movie_output.avi --size 10
...
#	print('Old threshold = ', th)
	...
	# lab = le.inverse_transform(lb)
	label = LABELS[i]
    # label_tmp = le.inverse_transform(lb[i])
