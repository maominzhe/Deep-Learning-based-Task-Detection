# USAGE
# python train.py --dataset data --model model_own/activity.model --label-bin model_own/lb.pickle --epochs 80
...
LABELS = set(["measuring_r_1", "measuring_r_2", "measuring_w_1", "measuring_w_2","sawing_r1","sawing_r2",
